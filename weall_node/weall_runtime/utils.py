...
"""
Utility functions for deterministic randomness, hashing, juror selection, and thresholds.
Used across governance, PoH, and disputes.
"""
...
def choose_jurors_for_application(node, count=10):
    ...
    """
    pool = node.get_registered_jurors()  # implement this on Node / Executor
    if not pool:
        return []
